...
import console from '../../images/connect-laravel-app--console.png'
import database from '../../images/connect-laravel-app--database.png'
import example from '../../images/connect-laravel-app--example.png'
...
<ImageBlock alt='Laravel PlanetScale starter app homepage' src={example} />
...
<ImageBlock alt='PlanetScale web console' src={console} />
