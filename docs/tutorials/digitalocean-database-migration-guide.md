...
![The Overview of the database cluster.](/docs/tutorials/digitalocean-database-migration-guide/the-overview-of-the-database-cluster.png)
...
![The Users & Databases view of the cluster with the Databases section highlighted.](/docs/tutorials/digitalocean-database-migration-guide/the-users-and-databases-view-of-the-cluster-with-the-databases-section-highlighted.png)
...
![The Settings tab of the database cluster in Digital Ocean.](/docs/tutorials/digitalocean-database-migration-guide/the-settings-tab-of-the-database-cluster-in-digital-ocean.png)
...
![The Trusted sources section of the Settings tab.](/docs/tutorials/digitalocean-database-migration-guide/the-trusted-sources-section-of-the-settings-tab.png)
...
![The Settings tab of the database cluster in DigitalOcean with the Global SQL mode section highlighted.](/docs/tutorials/digitalocean-database-migration-guide/the-settings-tab-of-the-database-cluster-in-digitalocean-with-the-global-sql-mode-section-highlighted.png)

To remove the `ANSI_QUOTES` setting, click the “**x**” next to the tag and click “**Save**.” The change should apply immediately.

![An example of removing the ANSI_QUOTES setting from the Global SQL mode settings.](/docs/tutorials/digitalocean-database-migration-guide/an-example-of-removing-the-ansi_quotes-setting-from-the-global-sql-mode-settings.png)

## Importing your database

In the PlanetScale dashboard, click “**New database”**, then “**Import database”**.

![The default view of all databases in the PlanetScale organization.](/docs/tutorials/digitalocean-database-migration-guide/the-default-view-of-all-databases-in-the-planetscale-organization.png)
...
![The Join beta view.](/docs/tutorials/digitalocean-database-migration-guide/the-join-beta-view.png)
...
![The Import external database form.](/docs/tutorials/digitalocean-database-migration-guide/the-import-external-database-form.png)
...
![The notice shown when PlanetScale has successfully connected to the external database.](/docs/tutorials/digitalocean-database-migration-guide/the-notice-shown-when-planetscale-has-successfully-connected-to-the-external-database.png)

You’ll then be moved to a page where you can monitor the import status of the database from DigitalOcean.

![The default view of the database in PlanetScale while the import is in progress.](/docs/tutorials/digitalocean-database-migration-guide/the-default-view-of-the-database-in-planetscale-while-the-import-is-in-progress.png)
...
![The view of the database in PlanetScale once the initial import has completed.](/docs/tutorials/digitalocean-database-migration-guide/the-view-of-the-database-in-planetscale-once-the-initial-import-has-completed.png)
...
![The view of the database in PlanetScale once the database is set to primary mode.](/docs/tutorials/digitalocean-database-migration-guide/the-view-of-the-database-in-planetscale-once-the-database-is-set-to-primary-mode.png)
