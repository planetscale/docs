...
import credentials from '@/images/connect-any-application--credentials.png'
...
While *developing* your application, you'll need to connect to a *development* branch. Your production application, however, should be connected to your production database branch. Check out our [Branching guide](/docs/concepts/branching) for more information about the branching workflow.
...
<ImageBlock alt='Credentials to connect to PlanetScale' src={credentials} />
