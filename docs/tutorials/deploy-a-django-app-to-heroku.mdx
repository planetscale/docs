...
import connect from '@/images/deploy-a-django-app-to-heroku--connect.png'
import database from '@/images/deploy-a-django-app-to-heroku--database.png'
import heroku from '@/images/deploy-a-django-app-to-heroku--heroku.png'
import ssl from '@/images/deploy-a-django-app-to-heroku--ssl.png'
...
<ImageBlock alt='The location of the “Connect” button in the PlanetScale dashboard.' src={database} />
...
<ImageBlock alt='The connection details for the project.' src={connect} />
...
<ImageBlock alt='The Settings tab of the Heroku dashboard.' src={heroku} />
...
<ImageBlock alt='The Config Vars setup for the project.' src={ssl} />
