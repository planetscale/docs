...
<ImageBlock alt='Prisma Studio showing the Star table with one record' src={studio} />
...
<ImageBlock alt='Example of the Star table schema in a deploy request on PlanetScale' src={schema} />
