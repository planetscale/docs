...
import environmentVariables from '@/images/deploy-to-vercel--environment-variables.png'
...
<ImageBlock alt='Vercel dashboard - Environment variables' src={environmentVariables} />
