...
{% callout %}
  You're configuring the __development__ Rails environment here for the sake of expedience. In actual use, the __main__ database branch would typically serve the __production__ environment.
{% /callout %}
