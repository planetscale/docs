...
{% callout %}
  You're configuring the __development__ Rails environment here for the sake of expedience. In actual use, the <b>main</b> database branch would typically serve the <b>production</b> environment.
{% /callout %}
