...
![PHP sample application homepage](/docs/tutorials/connect-php-app/example.png)
...
If you're not using the CLI, you can get the exact values to copy/paste from your PlanetScale dashboard. In the dashboard, click on the branch you want to connect to (we're using `main`), click "**Connect**", and select "**PHP**" from the language dropdown. Copy these credentials, and then skip to step 2 to fill them in.
