...
import img0 from '../../images/azure-database-for-mysql-migration-guide--the-server-name-and-server-admin-login-name-located-in-the-azure-dashboard.png'
import img2 from '../../images/azure-database-for-mysql-migration-guide--the-networking-tab-of-the-azure-dashboard.png'
import img3 from '../../images/azure-database-for-mysql-migration-guide--how-to-access-gtid-settings-in-the-azure-dashboard.png'
import img5 from '../../images/azure-database-for-mysql-migration-guide--the-join-beta-view.png'
import img6 from '../../images/azure-database-for-mysql-migration-guide--the-import-external-database-form.png'
import img8 from '../../images/azure-database-for-mysql-migration-guide--the-database-import-view-during-the-initial-import-process.png'
import img10 from '../../images/azure-database-for-mysql-migration-guide--the-database-import-view-after-the-planetscale-database-has-been-flagged-as-the-primary-database.png'
import img1 from '../../images/azure-database-for-mysql-migration-guide--the-databases-tab-of-the-azure-dashboard.png'
import img4 from '../../images/azure-database-for-mysql-migration-guide--the-default-view-of-all-databases-in-the-planetscale-organization.png'
import img7 from '../../images/azure-database-for-mysql-migration-guide--the-message-that-shows-at-the-bottom-of-the-form-indicating-that-the-connection-was-successful.png'
import img9 from '../../images/azure-database-for-mysql-migration-guide--the-database-import-view-once-the-initial-import-has-been-completed.png'
...
<ImageBlock alt='The server name and server admin login name located in the Azure dashboard.' src={img0} />
...
<ImageBlock alt='The databases tab of the Azure dashboard.' src={img1} />
...
<ImageBlock alt='The networking tab of the Azure dashboard.' src={img2} />
...
<ImageBlock alt='How to access gtid settings in the Azure dashboard.' src={img3} />
...
<ImageBlock alt='The Import external database form.' src={img6} />
