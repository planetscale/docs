...
<InfoBlock type='note'>
  ...
  <a href='/docs/concepts/billing#planetscale-plans'>Scaler and Team plans</a> include automated backups every 12
  hours.
</InfoBlock>
...
<InfoBlock type='note'>
  ...
  <a href='/docs/concepts/billing#planetscale-plans'>free Hobby plan</a> and every 12 hours for the{' '}
  <a href='/docs/concepts/billing#planetscale-plans'>Scaler and Team plans</a>), you will be billed{' '}
