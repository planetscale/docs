...
import describe from '@/images/web-console--describe.png'
import production from '@/images/web-console--production.png'
import show from '@/images/web-console--show.png'
import tab from '@/images/web-console--tab.png'
...
<ImageBlock alt='Console tab' src={tab} />
...
<ImageBlock alt='SHOW TABLES; in the console' src={show} />

Use `DESCRIBE table_name;` to obtain information about a given table's structure.

<ImageBlock alt='DESCRIBE table_name; in the console' src={describe} />
...
<ImageBlock alt='Enable product branch web console access' src={production} />
