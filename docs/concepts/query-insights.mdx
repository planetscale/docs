...
import unnormalizedData from '@/images/query-insights--unnormalized-data.png'
import optIn from '@/images/query-insights--opt-in.png'
import errors from '@/images/query-insights--errors.png'
import errorsDetailed from '@/images/query-insights--errors-detailed-view.png'
...
<VimeoEmbed
  src='https://player.vimeo.com/video/763945350'
...
<InfoBlock type='note'>
  You have the option to <a href="#complete-query-collection">opt in to complete query collection</a> to see the full SQL statements.
</InfoBlock>
...
<ImageBlock alt='PlanetScale Insights errors tab' src={errors} />
...
<ImageBlock alt='PlanetScale Insights errors tab deep dive showing queries' src={errorsDetailed} />
...
<ImageBlock alt='PlanetScale Insights complete query collection opt in' src={optIn} />
...
<ImageBlock alt='PlanetScale Insights unnormalized data in query deep dive' src={unnormalizedData} />
