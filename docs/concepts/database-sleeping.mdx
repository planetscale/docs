...
![PlanetScale dashboard overview page - Sleeping databases](/docs/concepts/database-sleeping/databases.png)
...
![PlanetScale dashboard database page - Sleeping database](/docs/concepts/database-sleeping/database.png)
