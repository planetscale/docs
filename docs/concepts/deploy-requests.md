...
![Example of deploy request on branch page](/assets/docs/concepts/deploy-requests/deploy-request-page.png?v2)
...
6. If you have required deploy requests to be approved before deployment, other users in your Organization will see the option to "**Approve changes**" or "**Leave a comment**" on the "**Schema changes**" tab.
   ...
   ![PlanetScale deploy request - approve changes](/assets/docs/concepts/deploy-requests/approve.png?v2)
...
1. When you open a deploy request, uncheck the "**Auto-apply changes**" box.
   ...
   ![PlanetScale deploy request - Auto-apply changes checkbox unchecked](/assets/docs/concepts/deploy-requests/gated-deployments.png?v2)
...
![PlanetScale deploy request - Apply changes from deployment button](/assets/docs/concepts/deploy-requests/apply-changes.png?v2)
