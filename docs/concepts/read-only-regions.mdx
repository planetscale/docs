...
With the PlanetScale Portals (beta), you can replicate your production database across the globe by creating read-only regions in any available [AWS PlanetScale region](/docs/concepts/regions).
