...
import event from '@/images/audit-log--event.png'
...
Audit log retainment period is [based on your plan](/docs/concepts/billing#planet-scale-plans):
...
<InfoBlock type='note'>
  Organization audit log access is limited to{' '}
  <a href='/docs/concepts/access-control#organization-administrator'>Organization Administrators</a>.
</InfoBlock>
...
<ImageBlock alt='Click to expand individual log events.' src={event} />
