...
import deployRequest from '@/images/branching--deploy-request.png'
import diagram from '@/images/branching--diagram.png'
...
<ImageBlock alt='PlanetScale Branching Flow Diagram' src={diagram} />
...
<VimeoEmbed
  src='https://player.vimeo.com/video/763913898'
  alt='Demonstration of how to promote a branch to production'
/>
...
It's possible to run multiple production branches simultaneously, within [your plan's limits](/docs/concepts/billing#planet-scale-plans). Keep in mind, PlanetScale does not provide data syncing between production branches.

## Create a development branch

<VimeoEmbed
  src='https://player.vimeo.com/video/763914056'
  alt='Demonstration of how to create a PlanetScale branch'
/>
...
<VimeoEmbed
  ...
  alt='Demonstration of how to create a deploy request'
/>
...
<ImageBlock alt='PlanetScale deploy request example' src={deployRequest} />
...
<VimeoEmbed
  src='https://player.vimeo.com/video/763913969'
  alt='Demonstration of how to add a deploy request to the deploy queue'
/>
