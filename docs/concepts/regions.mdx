...
import branch from '@/images/regions--branch.png'
import database from '@/images/regions--database.png'
import restrict from '@/images/regions--restrict.png'
...
<InfoBlock type='note'>
  If you don't see your preferred region(s) in the following list, we can still accommodate you with our Managed Cloud plan. For more information, see the [Deployment options documentation](/concepts/deployment-options#managed-cloud) or [get in touch](/contact).
</InfoBlock>
...
<InfoBlock type='note'>Once you select a branch region, it cannot be changed.</InfoBlock>
