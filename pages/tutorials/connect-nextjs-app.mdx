...
import database from '../../images/connect-nextjs-app--database.png'
import production from '../../images/connect-nextjs-app--production.png'
...
<ImageBlock alt='Create a new database modal' src={database} />
...
<ImageBlock alt='Promote a branch to production' src={production} />
