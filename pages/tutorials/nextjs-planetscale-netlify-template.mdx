...
import example from '../../images/nextjs-planetscale-netlify-template--example.png'
import starter from '../../images/nextjs-planetscale-netlify-template--starter.png'
...
<ImageBlock alt='Example of the dashboard application' src={example} />
...
[![Deploy to Netlify button](https://www.netlify.com/docs/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/planetscale/nextjs-planetscale-starter)
...
<ImageBlock alt='Next.js PlanetScale Starter application homepage' src={starter} />

## Database setup

Next, you need to set up your PlanetScale database. If you don't already have a [PlanetScale account](/docs/concepts/billing#planet-scale-plans), you can [sign up for a free one here](https://auth.planetscale.com/sign-up).
...
Alternatively, [sign in and create a database with the CLI](/docs/tutorials/planetscale-quick-start-guide#getting-started-planet-scale-cli) by running the following:
