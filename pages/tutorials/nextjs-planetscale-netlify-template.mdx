...
![Example of the dashboard application](/docs/img/docs/nextjs-admin-dashboard.png)
...
![Next.js PlanetScale Starter application homepage](/docs/img/docs/planetscale-nextjs-application.png)
