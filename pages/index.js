  ...
  return (
    <Layout>
      ...
      <div className='p-3 mb-3 border border-purple-100 rounded md:rounded-lg md:mb-4 bg-purple-50 dark:bg-purple-900 dark:border-purple-800'>
        ...
        <p className='mb-2'>
          Treat your databases as code. Use the PlanetScale developer workflows with the Data Branching&trade; feature, non-blocking schema changes, reverting schema changes, and more.
        </p>
        <p>
