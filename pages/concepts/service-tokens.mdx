...
import modal from '../../images/concepts/service-tokens/new-service-token-modal.png'
import serviceToken from '../../images/concepts/service-tokens/modal-with-service-token.png'
import settings from '../../images/concepts/service-tokens/service-tokens-settings-page.png'
import serviceTokenConfigView from '../../images/concepts/service-tokens/service-token-add-db-access.png'
import dbAccessPerms from '../../images/concepts/service-tokens/db-access-permissions.png'
import modifyDbPerms from '../../images/concepts/service-tokens/modify-db-perms.png'
import modifyDbPermsModal from '../../images/concepts/service-tokens/modify-db-access-perms-modal.png'
import removeAccess from '../../images/concepts/service-tokens/service-token-remove-access.png'
import deleteToken from '../../images/concepts/service-tokens/delete-service-token.png'
...
To create a service token using the dashboard, log into your organiaztion and click **"Settings"** > **"Service tokens"** > **"New service token"**.
