...
<InfoBlock type='note'>
  Only <a href="/docs/concepts/access-control#organization-administrator">Organization Administrators</a> can create and manage Teams.
</InfoBlock>
...
![Dashboard UI - Create a PlanetScale team](/docs/img/docs/create-a-team.png)
...
![Dashboard UI - Database Administrators settings page](/docs/img/docs/team-database-access.png)
...
![Dashboard UI - Delete a member from a team](/docs/img/docs/delete-a-member.png)
...
![Dashboard UI - Delete a database from a team](/docs/img/docs/delete-a-database.png)
