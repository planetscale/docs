...
<VideoBlock src='/docs/img/docs/promote-a-branch-to-production.mp4' />
...
<VideoBlock src='/docs/img/docs/create-new-branch.mp4' />
...
<VideoBlock src='/docs/img/docs/add-to-deploy-queue.mp4' />
...
<InfoBlock type='note'>
  Only <a href='/docs/concepts/access-control#organization-administrator'>Organization Administrators</a> have
  permission to delete production branches.
</InfoBlock>
