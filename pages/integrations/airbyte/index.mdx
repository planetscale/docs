...
import replicationFrequency from './replication-frequency.png'
import source from './source.png'
import streams from './streams.png'
...
<ImageBlock alt='Airbyte new PlanetScale connector' src={connector} />
...
<ImageBlock alt='Airbyte - PlanetScale source setup' src={source} />
...
<ImageBlock alt='Airbyte - PlanetScale replication frequency' src={replicationFrequency} />
...
<ImageBlock alt='Airbyte - PlanetScale stream sync' src={streams} />
...
<ImageBlock alt='Airbyte - PlanetScale disconnection' src={disconnect} />
