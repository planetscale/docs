...
![Add Stitch Integration](/docs/img/docs/stitch-add-integration.png)
4. On the next screen, configure your integration name and destination.
![Configure Stitch Integration](/docs/img/docs/stitch-configure-integration.png)
5. Once the integration is created, save the access token for use with the PlanetScale tap.
 ![Save Stitch API Token](/docs/img/docs/stitch-api-token.png)
...
![Stitch Source config](/docs/img/docs/stitch-source-config.png)
...
![Completed Stitch import](/docs/img/docs/stitch-import-done.png)
