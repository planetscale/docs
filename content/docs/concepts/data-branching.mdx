...
The PlanetScale Data Branching&trade; feature (beta) allows you to create isolated copies of your database that include both the schema and data. This differs from our [regular branching feature](/concepts/branching), which only includes the schema.
