...
subtitle: 'Create a development or staging environment for your database pre-seeded with data & schema'
---

## Overview

The PlanetScale Data Branching&trade; feature allows you to create isolated copies of your database that include both the schema and data. This differs from our [regular branching feature](/concepts/branching), which only includes the schema.
...
<VideoBlock src='/img/docs/enable-data-branching.mp4' />
...
![PlanetScale dashboard new branch dialog with seed option](/img/docs/new-data-branch.png)
3. Once you've selected an option, click "**Create branch**" to create a new branch.

<VideoBlock src='/img/docs/create-new-data-branch.mp4' />
...
5. **Will I be billed any more for my new branch?**

   PlanetScale will bill for the data inside of the new branch as part of your overall database's [plan](/concepts/billing#planetscale-plans). In this way, it is no different than if you filled the branch up manually.
