...
PlanetScale allows you to [create and manage passwords](/concepts/connection-strings) for each branch of your database. PlanetScale passwords can be created with one of four roles:
