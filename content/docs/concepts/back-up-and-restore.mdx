...
<InfoBlock  type="note">
A note: Daily backups of database branches are included free of charge for all databases.
</InfoBlock>
...
## Schedule backups
You can schedule additional backups for both your `main` and _development_ branches.
