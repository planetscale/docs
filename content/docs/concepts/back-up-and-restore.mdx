...
<InfoBlock type="note">
  Daily backups of database branches are included free of charge for all databases. Our <a href="/docs/concepts/billing#planetscale-plans">Scaler and Team plans</a> include automated backups every 12 hours.
</InfoBlock>
...
<InfoBlock type="note">
  For additional scheduled backups beyond the included default (daily for the <a href="/docs/concepts/billing#planetscale-plans">free Hobby plan</a> and every 12 hours for the <a href="/docs/concepts/billing#planetscale-plans">Scaler and Team plans</a>), you will be billed <b>$0.023 per GB per month</b>.
</InfoBlock>
