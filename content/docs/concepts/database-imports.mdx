...
During step one, your external database is imported into your PlanetScale database. The connection remains open during this phase. We'll continue watching your database and automatically update it with any changes you make to your external database.
...
After you detach the external database, PlanetScale's connection to that database will be closed and all connection information will be deleted from PlanetScale.
