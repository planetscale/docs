...
2. Give your imported database a name and [select a region](/concepts/regions) from the dropdown.
...
If you're importing a large database (that uses over 5 GB of storage) and are on the [Hobby plan](https://planetscale.com/pricing), you will receive a prompt as shown below to upgrade your plan:

![Upgrade your hobby plan if importing more than 5 GB](/img/docs/imports-upgrade-cta.png)
...
![Account upgraded, continue to importing database](/img/docs/upgraded-import-continue.png)
...
At this point, you can also view [Query Insights](/concepts/query-insights), branches, and database settings by clicking around in the top nav.
...
PlanetScale requires that all tables have a unique, not-null key that remains unchanged during the migration. If you run into this error, you can read through our [Change single unique key documentation](/learn/change-single-unique-key#how-to-change-a-table's-single-unique-key) for more information.
...
This means the import process is underway, and this error should clear in a matter of 10-15 minutes after some additional processing by PlanetScale. If it does not, contact our [the PlanetScale support team](https://www.planetscale.com/support) and we will help troubleshoot the issue. 

## Additional assistance

If you need additional assistance, contact our [the PlanetScale support team](https://www.planetscale.com/support), or join our [GitHub Discussion board](https://github.com/planetscale/discussion/discussions).
