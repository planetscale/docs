...
![Select name and region for new database import](/docs/img/docs/database-import-planetscale.png)
...
![Upgrade your hobby plan if importing more than 5 GB](/docs/img/docs/imports-upgrade-cta.png)
...
![Account upgraded, continue to importing database](/docs/img/docs/upgraded-import-continue.png)
...
![Step 1 of database import - Initial import](/docs/img/docs/database-imports-step-1.png)
...
![Step 2 of database import - Replica mode](/docs/img/docs/database-imports-step-2.png)
...
![Step 3 of database import - Primary mode](/docs/img/docs/database-imports-step-3.png)
...
PlanetScale requires that all tables have a unique, not-null key that remains unchanged during the migration. If you run into this error, you can read through our [Change single unique key documentation](/docs/learn/change-single-unique-key#how-to-change-a-table's-single-unique-key) for more information.
