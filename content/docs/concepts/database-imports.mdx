...
At this point, you can [connect your application](/tutorials/connect-any-application) to the PlanetScale database and ensure that it is fully compatible with your app. Queries will be served by PlanetScale and writes will be routed **back to your external database**, and then replicated back to PlanetScale to stay in sync. 
