...
Please take a look at our help document on how your application can [operate without foreign key constraints](/learn/operating-without-foreign-keys-constraints).
