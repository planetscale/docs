...
Please take a look at our help document on how your application can [operate without foreign key constraints](https://docs.planetscale.com/learn/operating-without-foreign-key-constraints).
