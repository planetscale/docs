...
<InfoBlock type='tip'>
  You'll see an `ERROR 1105 (HY000): direct DDL is disabled` message if you attempt to make schema changes in a production branch. Create a development branch, and make your changes there.
</InfoBlock>
