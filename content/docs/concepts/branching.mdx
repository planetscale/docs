...
<InfoBlock type='note'>Data from the main database is not copied to the developer's development branch.</InfoBlock>
...
<InfoBlock type='tip'>
  PlanetScale also provides the ability to have teammates comment and review deploy requests.
</InfoBlock>
