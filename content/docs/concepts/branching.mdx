...
<InfoBlock type="tip">
  You'll see a <inlineCode>ERROR 1105 (HY000): direct DDL is disabled</inlineCode> message if you attempt schema changes in a production branch. Create a development branch and start your changes there.
</InfoBlock>
