...
<InfoBlock type='tip'>
  You'll see a `ERROR 1105 (HY000): direct DDL is disabled` message if you attempt to make schema changes
  in a production branch. Instead, create a development branch, and make your changes there.
</InfoBlock>

## Promote a branch to production 

<video src='/img/docs/promote-a-branch-to-production.mp4'>
</video>
...
<video src="/img/docs/create-new-branch.mp4">
</video>
...
5. (*Optional*) You can also create a new branch from the [PlanetScale CLI](/reference/branch) with:
...
<video src="/img/docs/create-deploy-request.mp4">
</video>
...
<video src="/img/docs/add-to-deploy-queue.mp4">
</video>
...
<InfoBlock type="note">
Only <a href="/concepts/access-control#organization-administrator">Organization Administrators</a> have permission to delete production branches.
</InfoBlock>
