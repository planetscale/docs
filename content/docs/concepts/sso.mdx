...
[Contact our sales team](https://www.planetscale.com/contact) to get SSO enabled for your organization.
...
<InfoBlock type='note'>
  Organization administrators always remain in the <em>organization</em>, so they can configure SSO without losing
  access to the <em>organization</em>.
</InfoBlock>
