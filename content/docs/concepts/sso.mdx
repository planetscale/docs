...
<InfoBlock type='note'>
  ...
  <a href='/concepts/billing#planet-scale-plans'>Team and Enterprise plans</a>.
</InfoBlock>

## Enable SSO for your organization

[Contact us](https://planetscale.com/contact) to get SSO enabled for your organization.
...
<InfoBlock type='note'>
  <a href="/docs/concepts/access-control#organization-administrator">Organization Administrators</a> always remain in the organization, so they can configure SSO without losing access to the organization.
</InfoBlock>
