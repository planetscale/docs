...
<InfoBlock  type="note">
<b>A note:</b> SSO is only available as an <em>add-on</em> or as part of an <a href="https://docs.planetscale.com/concepts/billing#planetscale-plans">Enterprise plan</a>.
</InfoBlock>
...
<InfoBlock  type="note">
<b>A note:</b> Organization administrators always remain in the <em>organization</em>, so they can configure SSO without losing access to the <em>organization</em>.
</InfoBlock>
