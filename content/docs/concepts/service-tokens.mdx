...
![Service token settings page](/docs/img/docs/servicetokens-settings-overview.png)

2. Click on the "New service token" button

This will open a pop-up modal that prompts you to name the service token.

![New service token pop-up modal](/docs/img/docs/servicetokens-create-modal.png)
...
![Service token detail page](/docs/img/docs/servicetokens-token-detail.png)
...
![Database access permissions pop-up modal](/docs/img/docs/servicetokens-database-access-permissions.png)
...
![Manage Permissions](/docs/img/docs/servicetokens-database-access.png)
