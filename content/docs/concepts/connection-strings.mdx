...
![Database overview page](/docs/img/docs/create_new_password_1.png)
...
![Browse connection string in formats](/docs/img/docs/create_new_password_3.png)
...
![Manage passwords page](/docs/img/docs/manage_passwords.png)
