...
<b>Warning:</b> PlanetScale doesn't maintain the passwords for these accounts. Losing access to your GitHub account prevents accessing your PlanetScale account.
</InfoBlock>

<InfoBlock type="note">
<b>A note:</b> Enabling SSO removes OAuth access for all members of your <em>organization</em>, meaning they will no longer be able to sign in with their GitHub credentials.
</InfoBlock>
