...
You must first opt-in to the beta terms before you can use Rewind. Go to the database Settings page, click "Beta features", and check "Enroll this database in the Rewind limited beta" to opt-in.
...
5. Any data that was written to the original schema in the time between you deploying and reverting will remain in your database.
