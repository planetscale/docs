...
3. After your deploy request has been deployed, you have **30 minutes** to "undo" it.
4. To revert the schema changes made with the deploy request, click "**Revert changes**" and confirm.
5. Your production database will immediately be reverted back to it's previous schema before the deploy request.
6. Any data that was written in the time between you deploying and reverting will remain in your database.
7. The Deploy Request will be closed, but the branch will remain as is for you to continue development on if you choose.
