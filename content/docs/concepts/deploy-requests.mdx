...
For a in-depth look at how Rewind works, check out our [Behind the scenes: how we built Rewind](https://planetscale.com/blog/behind-the-scenes-how-we-built-rewind) blog post.
