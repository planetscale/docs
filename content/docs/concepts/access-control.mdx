...
| `request_deploy` | Create a deploy request for a database in an organization |
| `show_branch` | View a branch for a database in an organization |
| `show_database` | View a database in an organization  |
| `create_branch` | Create a branch for a database in an organization |
| `destroy_branch` | Delete a branch for a database in an organization |
| `list_query_stats` | View query statistics for a database in an organization |
...
| `create_production_service_token_grant` | Create a production service token |
