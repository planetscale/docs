...
| `update_integration` | Update an integration in an organization |
...
| Permissions              | Description                  |
| ------------------------ | ---------------------------- |
| `list_database_members` | View all members of all databases in an organization |
| `show_database_members` | View a member of all databases in an organization |
| `request_deploy` | Create a deploy request for all databases in an organization |
| `show_branch` | View a branch for all databases in an organization |
| `show_database` | View all databases in an organization  |
| `create_branch` | Create a branch for all databases in an organization |
| `destroy_branch` | Delete a branch for all databases in an organization |
| `list_query_stats` | View query statistics for all databases in an organization |
...
| Permissions | Description |
| ------------------------ | ---------------------------- |
| `update_database` | Update a specific database |
...
| `update_database_member` | Update a member of a specific database |
| `promote_branch` | Promote a branch of a specific database |
| `destroy_production_branch` | Delete the production branch of a specific database |
| `update_database_billing` | Update the billing of a specific database |
...
| `update_organization_member` | Update a member of an organization |
...
| `list_billing_sources` | View all billing sources |
| `add_billing_source` | Create a new billing source |
...
| `create_production_service_token_grant` | Create a production service token grant |
