...
If you wish to give several members the Database Administrator role, you may want to [create a Team](/concepts/teams#create-and-manage-teams). This will allow you to manage the access to that database all in one place. 

For instructions, see our [Teams documentation](/concepts/teams).
