...
You can also see a [list of all queries](#queries-list) performed on your database in the last 24 hours. You can sort these by different metrics like amount of rows read, time per query, and more.
...
- **Slow instances of the query** &mdash; Below the query pattern, we surface any slow instances of the query.
