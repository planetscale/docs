...
PlanetScale Portals is only available on our [paid Scaler, Teams, and Enterprise plans](https://planetscale.com/pricing).
...
As an example, let's say you're on our Scaler plan with 10 GB of included storage and your primary contains 5 GB of data. If you have two replicas, each one will be charged at our additional storage rate, for a total of 10 GB.  

For more information on storage billing costs, see our [Billing documentation](/concepts/billing#planetscale-plans).
