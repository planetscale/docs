...
![Console tab](/docs/img/docs/console-tab.png)
...
![SHOW TABLES; in the console](/docs/img/docs/console-show-tables.png)

Use `DESCRIBE table_name;` to obtain information about a given table's structure.

![DESCRIBE table_name; in the console](/docs/img/docs/describe-table.png)
...
![Enable product branch web console access](/docs/img/docs/enable-web-console.png)
