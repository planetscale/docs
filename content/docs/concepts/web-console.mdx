...
The PlanetScale web console can be used to query to any database branch; however, it is [disabled for production branches](https://docs.planetscale.com/concepts/web-console#enable-for-production-branches) by default to protect against accidental data loss. 
