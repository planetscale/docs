...
<InfoBlock type="tip">
Tip: To make Non-Blocking Schema Changes in PlanetScale, you'll first need a basic understanding of <a href="https://docs.planetscale.com/concepts/branching">branching</a>, the core PlanetScale feature that provide schema changes. Our branching concepts page is a great place to start.
</InfoBlock> 
...
![PlanetScale Non-Blocking Schema Changes Diagram](/img/docs/ps_nbsc_diagram.png)
