...
,. Your deployment makes it to the `main` branch _(i.e., production)_, and you can now see your schema changes in the production database.
...
PlanetScale doesn't support direct `RENAME` for columns and tables. Learn why and how to rename tables or columns in [this tutorial](/learn/handling-table-and-column-renames).
