...
<InfoBlock type='tip'>
  ...
  <a href='/docs/concepts/branching'>branching</a>, the core PlanetScale feature that provide
...
![PlanetScale non-blocking schema changes diagram](/docs/img/docs/ps_nbsc_diagram_light.png)
