...
PlanetScale doesn't support `FOREIGN KEY` constraints. Learn why and how to operate without foreign keys constraints in [this tutorial](/learn/operating-without-foreign-keys-constraints).
