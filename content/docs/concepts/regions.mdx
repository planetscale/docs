...
## Overview
PlanetScale currently offers database deployment in three regions. When creating a database, you should select the region closest to your application servers to reduce latency between your database and application. For database branches, selecting a region closest to the user's location would also help reduce latency with interacting with the database.
