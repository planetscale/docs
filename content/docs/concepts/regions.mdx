...
![Select your database region.](/docs/img/docs/database-region.png)
...
![Select your branch region.](/docs/img/docs/branch-region.png)
...
![Restrict your branches to one region.](/docs/img/docs/restrict-branch-region.png)
