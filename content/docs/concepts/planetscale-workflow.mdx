...
## PlanetScale Data Branching feature

The PlanetScale Data Branching&trade; feature allows you to treat your databases like code by unlocking the ability to branch databases.
