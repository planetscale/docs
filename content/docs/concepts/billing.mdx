...
<InfoBlock type="note">
  You are limited to <strong>one free database per organization</strong>. Free databases may be <a href="/concepts/database-sleeping">put to sleep</a> after a 15 day period of inactivity.
</InfoBlock>
