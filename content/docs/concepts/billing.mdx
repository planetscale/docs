...
- **Team** &mdash; 100 GB storage, 100 QPS storage, 500 billion row reads/mo, 100 million row writes/mo, 5 development environments
...
The first three plans offer an option to pay for additional usage and storage as you go.
...
| **Monthly fee**      | $0               | $29 per database              | $599 per database | [Contact us](https://planetscale.com/contact) |
...
You can add additional development branches to your Scaler plan in **packs of 5** for an extra $25/mo per pack.
...
You can add SSO for your organization under the Scaler plan for an additional fee. Please [contact us](https://planetscale.com/contact) to enable SSO.
