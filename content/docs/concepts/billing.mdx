...
You'll see a table of current and previous monthly invoices. You can download the invoice by month by clicking the "**Download**" button. This will send you to a Stripe invoice page where you'll have the option to download the complete invoice, see details, or download your receipt.
