...
PlanetScale offers a scalable, pay-as-you-grow plan model, which means you'll never have to over-provision resources while building your application.

We offer three plans, plus an additional customizable Enterprise option, summarized below:

- **Hobby** &mdash; 10 GB storage, 1 billion row reads/mo, 10 million row writes/mo, 1 development environment
- **Scaler** &mdash; 25 GB storage, 100 billion row reads/mo, 50 million row writes/mo, 3 development environments
- **Team** &mdash; 100 GB storage, 500 billion row reads/mo, 100 million row writes/mo, 5 development environments
- **Enterprise** &mdash; Resource-based pricing (free reads and writes), unlimited development environments, built-in horizontal sharding, dedicated resources provisioned

You can find the full list of plan offerings in the next section.
...
| -------------------- | -----------------| ------------------------------- | --------------------------- | --------------------------- |
| **Storage/month**    | 5 GB             | 25 GB* | 100 GB* | Configurable            | 
...
| **SSO**              | Not included     | Available for additional charge | Included | Included                     |
| **Support**          | Community        | Standard                      | Business | Premium                     |
...
SSO is included on Team and Enterprise plans. You can add SSO for your organization under the Scaler plan for an additional fee. Please [contact us](https://planetscale.com/contact) to enable SSO.
