...
| -------------------- | -------------------- | ------------------------------- | --------------------------------------------- |
| **Storage/month**    | 25GB                 | 25GB + $1.25 per additional 1GB | Configurable                                  |
...
All plans are billed on a **monthly basis**. For more information about the `Enterprise` plan, please [contact our sales team](https://www.planetscale.com/contact). 
