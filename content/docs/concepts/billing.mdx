...
| -------------------- | -------------------- | ------------------------------- | --------------------------------------------- |
| **Storage/month**    | 10 GB                 | 25 GB + $2.50 per additional 1 GB | Configurable                                  |
| **Row reads/month**  | 1 billion            | 100 billion + $1 per additional 1 billion | Configurable                                  |
| **Row writes/month** | 10 million           | 50 million + $1.50 per additional 1 million   | Configurable                                  |
| **Branches**         | 3 per database       | 10 per database                 | _Unlimited_                                   |
| **Audit log retention**|  5 days            | 15 days                         | _Unlimited_                                  |
| **Concurrent Connections**| 1,000           | 10,000                          | _Unlimited_                                   |
