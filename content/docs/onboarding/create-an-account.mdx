...
![The completed sign up screen on PlanetScale.](/docs/img/docs/account-setup/the-completed-sign-up-screen-on-planetscale.png)

You can also sign up using any existing GitHub account by clicking **"Continue with GitHub"**.

![How to create an account on PlanetScale using your GitHub account.](/docs/img/docs/account-setup/how-to-create-an-account-on-planetscale-using-your-github-account.png)

Once you complete the form, you’ll be redirected to a page stating your email address needs to be verified.

![The email verification notice.](/docs/img/docs/account-setup/the-email-verification-notice.png)

The email will contain a link you can click to verify that you own the address. Click the **"Confirm email"** button.

![An example of the confirmation email sent by PlanetScale.](/docs/img/docs/account-setup/an-example-of-the-confirmation-email-sent-by-planetscale.png)
...
![The "Welcome to PlanetScale" landing page](/docs/img/docs/account-setup/the-welcome-to-planetscale-landing-page.png)
