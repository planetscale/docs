...
This guide continues from the [previous entry](/onboarding/create-a-database) describing how to create a database. If you do not have a database created, follow the steps in that guide before proceeding
...
[TODO: Insert existing branching graphic here]
