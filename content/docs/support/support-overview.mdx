...
Standard and Premium Support plans include the ability to select a priority when submitting a support ticket through our web form. Premium Support customers also have SLAs for each priority.
...
| High | <li>Non production database or branch is unreachable</li><li>Payment issues</li><li>Production backup issues</li><li>Performance degradation</li> |
| Urgent | <li>Database or is unreachable</li><li>Severe performance degradation</li><li>Security related incident</li>|
