...
| High | Non-citical business impacting production database issues. | <li>Production impacting issue with low business impact</li><li>Production backup issues</li><li>Low to moderate performance degradation</li> |
| Urgent | Critical production database issues. | <li>Production impacting issue with high impact</li><li>Severe performance degradation</li><li>Security related incident</li>|
