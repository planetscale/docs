...
PlanetScale believes all our users, from those running a small free Hobby database to those running large mission critical workloads, deserve to get the help they need to.
...
- Available as an upgrade for all Team plans and default on any Enterprise plans
- Access to the [PlanetScale GitHub Discussion](https://github.com/planetscale/discussion/discussions) board
- Access to support engineers via [email](mailto:support@planetscale.com) and [web ticketing](https://support.planetscale.com/)
...
<InfoBlock type="note">
  ...
  12x5 means from 6am to 6pm Pacific Standard Time (UTC -8), Monday through Friday.
</InfoBlock>
...
<InfoBlock type="note">
  PlanetScale Support has the ability to alter a tickets priority if it does not generally match these guidelines.
</InfoBlock>
