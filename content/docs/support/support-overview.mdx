...
PlanetScale believes all our users, from those running a small free Hobby database to those running mission critical workloads, deserve to get the help they need to.
...
- Web and email support ticketing
...
- Enhanced response times including Urgent and Hhigh Priority 24/7 coverage
...
<InfoBlock type="note">
  ...
  12x5 means from 6am to 6pm Pacific Standard Time.
</InfoBlock>
