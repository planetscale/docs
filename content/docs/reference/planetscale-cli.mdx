...
Make sure to first [set up your PlanetScale developer environment](/concepts/planetscale-environment-setup). Once you've installed the `pscale` CLI, you'll be able to interact with PlanetScale and manage your databases.
