...
------------- ----------- ------------------------ ------------------------ --------------- ---------------- ------------
9ded34uzslv7  Name        Open_web_console main    branch.open_web_console  xxx.xxx.xxx.x   Los Angeles, CA  1 day ago
```
...
```bash
pscale audit-log list --limit 5 --starting-after 9ded34uzslv7
```
