...
When importing a database using our [Import tool](/concepts/database-imports), you will need to connect to your existing database with a user that has the proper permissions to setup the necessary configurations to start importing data.
...
| Table  | `_vt`                    | `UPDATE`             | Enable use of UPDATE.                                                        |
| Table  | `_vt`                    | `DELETE`             | Enable use of DELETE.                                                        |
