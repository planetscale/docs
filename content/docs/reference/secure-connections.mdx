...
This path also applies to Debian or Ubuntu derivatives.

```
/etc/ssl/certs/ca-certificates.crt
```

#### RedHat / Fedora / CentOS / Vercel

This path also applies to RedHat or Fedora derivatives like Amazon Linux. This is the path to use for applications deployed on Vercel.
...
MacOS provides an extracted version of the system roots on disk that can be used for the CA roots.
