...
This command allows you create, list, and manage access for service tokens.
...
Some of the sub-commands have additional flags unique to the sub-command. This section covers what each of those do. See the above table for which context.
...
You can find a list of all permissions in our [Access control doc](/concepts/access-control).
...
DATABASE               ACCESSES
---------------------- -----------------------------------------------------------
DATABASE_NAME           approve_deploy_request, connect_branch,
                        connect_production_branch, create_branch, create_comment,
                        create_deploy_request, delete_branch, read_branch,
                        read_comment, read_deploy_request
