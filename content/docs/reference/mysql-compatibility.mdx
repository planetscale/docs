...
| `PIPES_AS_CONCAT` | ✖️ | The `\|\|` operator is reserved for Vitess' evalengine so enabling this SQL mode may result in incorrect or unexpected results. Please use `CONCAT()` instead. |
