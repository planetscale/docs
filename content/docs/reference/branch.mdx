...
This command allows you to create, delete, diff, and manage [branches](/concepts/branching).
...
| -------- | -------- | --------------------------------------- |
| `create <DATABASE_NAME> <BRANCH_NAME>` | `--from <SOURCE_BRANCH>`, `--region <BRANCH_REGION>`, `--restore <BACKUP_NAME>`, `--web` | Create a new branch on the specified database |
