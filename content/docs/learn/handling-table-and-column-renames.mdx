...
If you do need to rename a column or table, the following section covers how you should do it with PlanetScale via [Deploy Requests](/concepts/deploy-requests).
