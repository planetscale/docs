...
Start by cloning the following Git repository to your computer.
...
Click the **Upload** button which will display a file browser. Select the **aws-connection-strings-example.zip** file from the **dist** folder of the repository. Click **Save** once it’s been selected.
...
Now to set the environment variable, select the **Configuration** tab and click **Edit**.
