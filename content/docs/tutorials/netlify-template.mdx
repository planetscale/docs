...
<br/>
<br/>
If you're <strong>starting fresh and haven't deployed yet</strong>, you can also start from the beginning of this tutorial, as it will cover Netlify deployment at the end. If you want to deploy using the Netlify one-click deploy button, skip to the <a href="#one-click-deploy-button">Netlify section</a> right now, and then come back to the top to continue.
</InfoBlock>
...
## Set up the production admin account
