---
title: 'Netlify template tutorial'
subtitle: ''
---
...
If you already went through the [Netlify deployment](https://templates.netlify.com/template/nextjs-planetscale-starter/), find the repository in your GitHub account and clone that one.

If you just want to run the template locally, you can clone the [`nextjs-planetscale-starter` repository](https://github.com/planetscale/nextjs-planetscale-starter).
