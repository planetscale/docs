...
<InfoBlock type='note'>
  ...
  tool user permissions page](/reference/import-tool-user-requirements) to create an account that can be used to import
  your database.
</InfoBlock>
...
GRANT SELECT, INSERT, LOCK TABLES ON <DATABASE_NAME>.* TO `migration_user`@`%`;
