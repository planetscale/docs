...
The `MYSQL_ATTR_SSL_CA` value is platform dependent. Please see our documentation around [how to connect to PlanetScale securely](https://docs.planetscale.com/reference/secure-connections#ca-root-configuration) for the configuration for the platform you're using.
