...
This guide will integrate [a simple Laravel app](https://github.com/planetscale/laravel-example.git) with PlanetScale that will display a list of stars stored in the database. If you have an existing application, you can also use that.
...
![Laravel PlanetScale starter app homepage](/img/docs/laravel-planetscale-example-data-edit.png)
