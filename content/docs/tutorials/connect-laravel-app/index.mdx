...
- **Region** &mdash; Choose the [region](/concepts/regions#available-regions) closest to you or your application. It's important to note if you intend to make this branch a production branch, you will not be able to change the region later, so choose the region with this in mind.

Finally, click "**Create database**".

![Create a new database modal](/img/docs/laravel-quickstart/create-database.png)
...
- [PlanetScale CLI shell](/reference/shell)
...
PlanetScale has a [built-in console](/concepts/web-console) where you can run MySQL commands against your branches. To access it, click "**Branches**" > your development branch > "**Console**".
...
![PlanetScale web console](/img/docs/laravel-quickstart/planetscale-web-console.png)
...
- [PlanetScale branching](/concepts/branching) &mdash; Learn how to utilize branching to ship schema changes with no locking or downtime.
