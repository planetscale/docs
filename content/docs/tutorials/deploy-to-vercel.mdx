...
- A project deployed to Vercel &mdash; If you're just poking around and don't already have an application to deploy, you can use our [Next.js + PlanetScale sample](/tutorials/connect-nextjs-app)
...
![PlanetScale dashboard connect modal](/img/docs/prisma-connection-modal.png)
