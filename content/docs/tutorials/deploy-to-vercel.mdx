...
>  This sample repo uses Next.js 9 (i think ?lol) and is in the process of being updated. If you'd like to see the most updated version with Vercel deployment, check out our Next.js Quickstart.
