...
This will deploy your `development` branch changes into `main`:
...
<InfoBlock type='tip'>
  Make sure you pick the same <b>database</b> that you created in the earlier part of this tutorial, so that it has the
  right schema.
</InfoBlock>
