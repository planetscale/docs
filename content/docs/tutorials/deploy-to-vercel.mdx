...
This guide will walk you through how to set up and deploy your PlanetScale database on Vercel.
...
- A PlanetScale database &mdash; If you haven't created a database, refer to our [PlanetScale quickstart guide](/tutorials/planetscale-quick-start-guide#getting-started-—-planetscale-dashboard) to get started
- A [Vercel account](https://vercel.com/)
- A project you're deploying to Vercel &mdash; If you're just poking around and don't already have an application to deploy, you can user our [Next.js + PlanetScale sample](/tutorials/connect-nextjs-app)

## Manually connect to Vercel

### Get your connection string from PlanetScale

1. In your [PlanetScale dashboard](https://app.planetscale.com), click on the database you want to connect.
2. Click "**Connect**".
...
![PlanetScale dashboard connect modal](/img/docs/deploy-to-vercel-connection.png)
...
![Vercel dashboard - Environment variables](/img/docs/vercel-environment-variables.png)
...
6. On the right side, choose the [PlanetScale Organization](/concepts/access-control#Overview) that the database is in. The integration will remain tied to this Organization and cannot be changed. 
...
After you set up the initial connection, you also have the option to configure the PlanetScale connection and/or add more databases to the project.
...
<InfoBlock>
  <div>
    <b>When removing the Vercel integration:</b>
    <ul>
