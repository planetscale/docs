...
>  This sample repo uses Next.js 10 and is in the process of being updated. If you'd like to see the most updated version with Vercel deployment, check out our [Next.js Quickstart](https://docs.planetscale.com/tutorials/connect-nextjs-app).
