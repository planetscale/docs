...
```
pscale password create <database-name> <branch-name> <name>
```

<InfoBlock type='note'>
  The <inlineCode>name</inlineCode> value represents the name of the connection string being generated. You can have multiple connection strings for a branch, so this gives you a way to categorize them.
</InfoBlock>
