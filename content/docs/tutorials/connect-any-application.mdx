...
- In the PlanetScale UI by following the instructions in our [Connection Strings doc](/concepts/connection-strings#creating-a-password)
...
Another way connect your application to your PlanetScale database is using client certificates. You won't have to fiddle with configuring any certificates, as that's handled by PlanetScale. It's as simple as a single CLI command.
