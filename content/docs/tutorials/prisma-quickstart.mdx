...
![Prisma Studio showing the Star table with one record](/docs/img/docs/prisma_studio_example.png)
...
![Example of the Star table schema in a deploy request on PlanetScale](/docs/img/docs/prisma_deploy_request_schema.png)
