...
In the `.env` file, fill in the `DATABASE_HOST`, `DATABASE_USERNAME`, and `DATABASE_PASSWORD` variables with the values you just created. It should look something like this:
