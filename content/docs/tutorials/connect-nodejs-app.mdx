...
<InfoBlock type='tip'>
  Running pscale connect with the execute flag will pass a DATABASE_URL to the node application, enabling it to connect
  to PlanetScale. Don't forget to look in app.js to see how the DATABASE_URL is used.
</InfoBlock>
