...
In the `.env` file, fill in the `DATABASE_HOST`, `DATABASE_NAME`, `DATABASE_USERNAME`, and `DATABASE_PASSWORD` variables with the values you just created. It should look something like this:

```env
DATABASE_HOST=gxvhbzcxfw01.us-east-2.psdb.cloud
DATABASE_NAME=express_database
DATABASE_USERNAME=jp71f987awnod
DATABASE_PASSWORD=pscale_pw_sVkiE_mtfxQirc4qGZXMf098as90d8as0d98asd
```
