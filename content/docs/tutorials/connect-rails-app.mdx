...
<InfoBlock type='tip'>
  Already have a Rails application and just want to connect to PlanetScale? Check out the [Rails quick connect repo](https://github.com/planetscale/examples/tree/main/ruby).
</InfoBlock>
