...
The correct `sslca` path depends on your operating system and distribution. See [CA root configuration](/docs/reference/planetscale-security#ca-root-configuration) for more information.
