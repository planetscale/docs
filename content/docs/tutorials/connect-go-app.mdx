...
<InfoBlock type='tip'>
  Already have a Go application and just want to connect to PlanetScale? Check out the [Go quick connect repo](https://github.com/planetscale/examples/tree/main/go).
</InfoBlock>
