...
PlanetScale does not support foreign key *constraints*, but we do support the use of relationships with foreign keys, as shown in this example. For more information, check out our [Operating without foreign key constraints](/docs/learn/operating-without-foreign-key-constraints) documentation.
...
![PlanetScale console insert and select example](/docs/img/docs/go-planetscale-console.png)
