...
- A project deployed to Netlify &mdash; If you're just poking around and don't already have an application to deploy, you can use our [Next.js + PlanetScale sample](/tutorials/connect-nextjs-app)
...
![Netlify dashboard - Environment variables](/img/docs/netlify-environment-variables.png)
