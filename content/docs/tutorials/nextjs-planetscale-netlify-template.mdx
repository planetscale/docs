...
Next, you need to set up your admin account for your application. Go to [http://localhost:3000/admin/setup](http://localhost:3000/admin/setup) in your browser and fill in the form to set up your account. This will be automatically saved to your PlanetScale database.
