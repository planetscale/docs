...
Finally, you can set up your production admin account for your application the same way you did locally. Go to [/admin/setup](/admin/setup) on your live Netlify site and fill in the form to set up your account. This will be automatically saved to your PlanetScale database.
