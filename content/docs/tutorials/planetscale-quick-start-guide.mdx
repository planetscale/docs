...
- **DATABASE_NAME** &mdash; Your database name can contain lowercase, alphanumeric characters, or dashes. We allow underscores, but don't recommend them, as they may need to be escaped in some instances.
