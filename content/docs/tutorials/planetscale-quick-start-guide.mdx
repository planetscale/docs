...
<InfoBlock type="note">
  When you branch off of a production branch, your development branch will have the same schema as production, but it <b>will not</b> copy over any data from the production database. We suggest seeding development branches with mock data.
</InfoBlock>
...
If you run into any issues or have any questions, we'd love to hear from you. You can contact [the PlanetScale support team](https://www.planetscale.com/support) or join our [GitHub Discussion board](https://github.com/planetscale/discussion/discussions) to see how others are using PlanetScale.
