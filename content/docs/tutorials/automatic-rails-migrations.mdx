...
<InfoBlock type="note">Automatic schema migrations work with any migration tool, not just Rails. Specify the migration table name in your database's Settings page.</InfoBlock>
