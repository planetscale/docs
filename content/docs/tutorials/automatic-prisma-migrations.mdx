...
2. Close the proxy connection to your `main` branch and connect to the new development branch:
...
4. Create a second Prisma migration for your table and call it `add-subtitle-to-posts`:
...
6. Once the deploy request is merged, you can see the results in your main branch's `Post` and `_prisma_migrations` tabled:
