...
You can use any name with lowercase, alphanumeric characters, and underscores. You can also uses dashes, but we don't recommend them, as they may need to be escaped in some instances.
