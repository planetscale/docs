...
1. Open the `.env` file in your PHP app:
...
You can also get these exact values to copy/paste from your PlanetScale dashboard. In the dashboard, click on the the branch you want to connect to (we're using `main`), click "**Connect**", and select "**PHP**" from the dropdown.
