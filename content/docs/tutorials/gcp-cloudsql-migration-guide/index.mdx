...
This document will demonstrate how to migrate a database from Google Cloud Platform (GCP) CloudSQL MySQL Cluster to PlanetScale using our [Import tool](/concepts/database-imports). We’ll also address some common issues associated with migrating from CloudSQL and how to resolve them.
...
In the form that appears, give your user a name and password. Make sure that **Allow any host** is selected. Click “**Add**”.
