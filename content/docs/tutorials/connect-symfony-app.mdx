...
```
DATABASE_URL="mysql://<USERNAME>:<PLAIN TEXT>@<ACCESS HOST URL>:3306/<DATABASE_NAME>?serverVersion=5.7"
```
...
![Symfony PlanetScale starter app homepage](/img/docs/Symfony-planetscale-example-data.png)
