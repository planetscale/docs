...
In this article, we’ll walk through migrating a MySQL database from DigitalOcean to PlanetScale using the [Import tool](/concepts/database-imports). We’ll also cover some common errors you may encounter while performing the migration.
