...
![Prisma Data Platform project configuration](/docs/img/docs/prisma-cloud-configuration.png)
...
![Prisma Data Platform project template options](/docs/img/docs/prisma-cloud-templates.png)
...
![Prisma Data Platform project database provider PlanetScale](/docs/img/docs/prisma-planetscale-login.png)
...
![Prisma Data Platform project PlanetScale configuration](/docs/img/docs/prisma-planetscale-configuration.png)
...
![PlanetScale dashboard with new Prisma + PlanetScale database](/docs/img/docs/prisma-planetscale-database.png)
