...
- A PlanetScale database — If you haven't created a database, refer to our [PlanetScale quickstart guide](https://docs.planetscale.com/docs/tutorials/planetscale-quick-start-guide#getting-started-%E2%80%94-planetscale-dashboard) to get started.
...
This article will make use of the [django-example GitHub repository](https://github.com/planetscale/django-example) that is built for the [Connect a Django application to PlanetScale document](https://docs.planetscale.com/docs/tutorials/connect-django-app)
...
![The location of the “Connect” button in the PlanetScale dashboard.](/docs/img/docs/deploy-a-django-app-to-heroku/the-location-of-the-connect-button-in-the-planetscale-dashboard.png)
...
![The connection details for the project.](/docs/img/docs/deploy-a-django-app-to-heroku/the-connection-details-for-the-project.png)
...
![The Settings tab of the Heroku dashboard.](/docs/img/docs/deploy-a-django-app-to-heroku/the-settings-tab-of-the-heroku-dashboard.png)

Setup a separate **Config Var** for each line you captured from the PlanetScale dashboard. The one exception is the `MYSQL_ATTR_SSL_CA`, which should be set to `/etc/ssl/certs/ca-certificates.crt`
...
![The Config Vars setup for the project.](/docs/img/docs/deploy-a-django-app-to-heroku/the-config-vars-setup-for-the-project.png)
