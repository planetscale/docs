...
![Airbyte new PlanetScale connector](/docs/img/docs/airbyte-new-connector.png)
...
![Airbyte - PlanetScale source setup](/docs/img/docs/airbyte-planetscale-source-setup.png)
...
![Airbyte - PlanetScale replication frequency](/docs/img/docs/airbyte-replication-frequency.png)
...
![Airbyte - PlanetScale stream sync](/docs/img/docs/airbyte-streams.png)
...
![Airbyte - PlanetScale disconnection](/docs/img/docs/airbyte-disconnect.png)
