...
![Add Stitch Integration](/img/docs/stitch-add-integration.png)
4. On the next screen, configure your integration name & destination.
![Configure Stitch Integration](/img/docs/stitch-configure-integration.png)
5. Once the integration is created, save the access token for use with the PlanetScale tap.
 ![Save Stitch API Token](/img/docs/stitch-api-token.png)
...
![Stitch Source config](/img/docs/stitch-source-config.png)
...
1. Install the PlanetScale Singer tap by running `brew install planetscale/tap/ps-singer-tap`
2. Install the PlanetScale Http tap by running `brew install planetscale/tap/ps-http-tap`
...
4. Select the schema elements you want synced. **TODO: We need do something about this**
...
8. In Stitch, you should see that it loaded `21` records to be replicated.
