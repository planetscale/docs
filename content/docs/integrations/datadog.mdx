...
<ImageBlock alt="Image of the PlanetScale Default Dashboard in Datadog showing overview metrics, table and row breakdowns, info about connections, and query rates" src="/docs/img/docs/datadog-dashboard.png" height={1988} width={2728} />
