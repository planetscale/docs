...
When you create a PlanetScaleDB database, you get a fully managed database inside a virtual private cloud. You can currently select between Amazon Web Services (AWS), Google Cloud Platform (GCP), or Microsoft Azure to deploy your virtual private cloud.
