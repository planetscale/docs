...
subtitle: 'This document explains how to import data into your database.'
---

<InfoBlock type="note">
  The steps in this document may be too slow for large databases. If you want to
  import a large database, contact us at support@planetscale.com.
</InfoBlock>
