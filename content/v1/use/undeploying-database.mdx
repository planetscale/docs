...
subtitle: 'This document describes how to undeploy your database from the PlanetScale console. This will delete the data in the database.'
---
...
![Undeploy button](/img/v1/undeploy.png)
