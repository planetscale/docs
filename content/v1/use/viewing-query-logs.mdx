...
subtitle: 'This document describes how to view recent queries against your database using the PlanetScaleDB console.'
---
...
## Step 5. In the right hand side of the Executor section, click Current Query Logs
