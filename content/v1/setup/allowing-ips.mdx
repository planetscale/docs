...
subtitle: 'This document describes how to allow specific IP addresses to connect to your PlanetScaleDB cluster.'
---
...
![Connection Security tab](/img/v1/connection-security-tab.png)
