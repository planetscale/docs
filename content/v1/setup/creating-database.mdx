...
subtitle: 'This document explains how to create a database using the PlanetScale console.'
---
...
![Clusters view](/img/v1/clusters-view.png)
...
![Create your first Database](/img/v1/create-database.png)
...
![Create New Database pane](/img/v1/create-new-database.png)
...
![Instance Configuration section](/img/v1/instance-configuration.png)
...
![Number of instances section](/img/v1/number-of-instances.png)
...
![Sharding section](/img/v1/sharding-section.png)
...
## Optional: Click your database name
