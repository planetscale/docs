...
subtitle: 'This document describes how to add additional users to your PlanetScale account.'
---
...
![Team button in the left menu](/img/v1/team-button.png)

## Step 3. Click Add User

![Add user button in team view](/img/v1/add-user-button.png)
