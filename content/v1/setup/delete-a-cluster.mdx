...
subtitle: 'This document descirbes how to delete a cluster from your PlanetScale account.'
---
...
![Delete Cluster settings option](/img/v1/gear-icon-delete-cluster.png)
...
![Delete Cluster pane](/img/v1/delete-cluster-pane.png)

## Step 5: Click Confirm

Then click **Confirm**.

![Confirm Delete Cluster pane](/img/v1/delete-cluster-pane-type.png)
