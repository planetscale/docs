...
subtitle: 'This document describes how to encrypt and authenticate the connection between your application and your PlanetScaleDB database using the TLS protocol.'
---
...
![Connection Security tab](/img/v1/certificate-authority-security-tab.png)

This displays your Certificate Authority certificate.

## Step 5. Click Copy

![Certificate Authority certificate copy button](/img/v1/copy-certificate-authority-security-tab.png)
