...
subtitle: 'Before you can create a database, you must first create a cluster. This document explains how to create a cluster using the PlanetScale console.'
---
...
![Create your first cluster screen](/img/v1/cluster-diagram.png)
...
![Create new cluster screen](/img/v1/create-new-cluster.png)
