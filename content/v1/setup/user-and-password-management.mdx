...
subtitle: 'This document describes how to manage users and passwords for your PlanetScaleDB clusters.'
---
...
![Security Tab](/img/v1/security-tab.png)

### Step 5. Click on Roles

![Roles Tab](/img/v1/roles-tab.png)

### Step 6. New roles are created by selecting Create new role

![Create new role](/img/v1/create-new-role.png)

### Step 7. Edit roles by selecting the Edit button

![Edit exiting role](/img/v1/edit-existing-role.png)
...
![Users Tab](/img/v1/users-tab.png)

### Step 6. New Users are created by selecting Create new user

![Create new user](/img/v1/create-new-user.png)

### Step 7. Edit Users by selecting the Edit button

![Edit exiting user](/img/v1/edit-existing-user.png)
...
![Enter new password](/img/v1/update-password.png)
...
- [Allowing access to specific IP addresses](allowing-ips)
