---
title: 'Overview'
subtitle: 'This document describes the purpose of the Vitess Operator for Kubernetes and introduces its usage.'
---

<InfoBlock type="note">
  To learn more about Vitess, see the https://vitess.io/docs.
</InfoBlock>
