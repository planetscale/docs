---
title: 'Overview'
subtitle: 'This document describes the purpose of the PlanetScaleDB Operator for Vitess and introduces its usage.'
---

<InfoBlock type="note">
  To learn more about Vitess, visit https://vitess.io/docs.
</InfoBlock>
