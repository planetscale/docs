---
title: 'Getting started with the PlanetScaleDB Operator on Google Cloud Platform'
subtitle: 'This document shows how to use the PlanetScaleDB Operator to deploy a Vitess cluster on Google Cloud Platform (GCP).'
---
