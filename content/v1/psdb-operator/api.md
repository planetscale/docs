...
<h3 id="planetscale.com/v2.PlanetScaleCluster">PlanetScaleCluster
</h3>
<p>
<p>PlanetScaleCluster is the top-level interface for configuring a cluster.</p>
<p>Although the PlanetScaleCluster controller creates various secondary objects
...
PlanetScaleCluster status, but any configuration changes should only be made in
the PlanetScaleCluster object.</p>
</p>
<table class="table table-striped">
<thead class="thead-dark">
<tr>
...
<td><code>PlanetScaleCluster</code></td>
</tr>
<tr>
<td>
<code>metadata</code><br/>
...
<td>
<p>Images allows overriding individual container image URLs (including tag)
that would otherwise be generated based on the parameters in the &lsquo;image&rsquo;
field. Use the &lsquo;image&rsquo; field instead unless you need to override certain
containers to different images than the rest for some reason.
Default: Generate image URLs based on parameters in the &lsquo;image&rsquo; field.</p>
</td>
</tr>
<tr>
<td>
...
use the images defined in the &lsquo;images&rsquo; field.
Default: ps-gcr-credentials</p>
</td>
</tr>
<tr>
<td>
...
<em>
<a href="#planetscale.com/v2.MonitoringSpec">
MonitoringSpec
</a>
</em>
</td>
<td>
<p>Monitoring deploys monitoring infrastructure for the cluster.
Default: Don&rsquo;t deploy monitoring infrastructure.</p>
</td>
</tr>
<tr>
<td>
<code>adminProxy</code><br/>
<em>
<a href="#planetscale.com/v2.AdminProxySpec">
AdminProxySpec
</a>
</em>
</td>
<td>
<p>AdminProxy deploys a proxy for Vitess cluster admins to access Vitess
component status pages from outside the Kubernetes cluster.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>NetworkPolicies specifies various NetworkPolicy for the PlanetScaleCluster</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>LockserverTLS specifies secret sources for the client certs, keys and server ca for vitess components to communicate
with a given lockserver over TLS. Note that this applies to both global and local lockserver communication.
Optional.</p>
</td>
</tr>
<tr>
...
<td>
<p>Replication configures Vitess replication settings for the cluster.
These defaults can be overridden at the per-shard level.</p>
</td>
</tr>
<tr>
<td>
<code>federation</code><br/>
<em>
<a href="#planetscale.com/v2.FederationSpec">
FederationSpec
</a>
</em>
</td>
<td>
<p>Federation configures the operator to cooperate with operators running in
...
enabled from the initial deployment of the PSC, even if no remote cells
are defined yet. The reverse migration is also not supported.</p>
<p>Default: Assume the whole Vitess cluster lives in one Kubernetes cluster.</p>
</td>
</tr>
</table>
</td>
...
<h3 id="planetscale.com/v2.ALBIngressSpec">ALBIngressSpec
</h3>
<p>
(<em>Appears on:</em>
...
<tr>
<td>
<code>backendProtocol</code><br/>
<em>
<a href="#planetscale.com/v2.ALBProtocol">
ALBProtocol
</a>
</em>
</td>
<td>
<p>BackendProtocol is the protocol used when talking to backend Pods.
Default: &ldquo;HTTP&rdquo;</p>
</td>
</tr>
<tr>
<td>
<code>scheme</code><br/>
<em>
<a href="#planetscale.com/v2.ALBScheme">
ALBScheme
</a>
</em>
</td>
<td>
<p>Scheme is whether the load balancer is internal or internet-facing.
Default: &ldquo;internal&rdquo;</p>
</td>
</tr>
<tr>
<td>
<code>certificateARNs</code><br/>
<em>
[]string
</em>
</td>
<td>
<p>CertificateARNs is a list of ARNs for certificates mananged by
AWS Certificate Manager.</p>
</td>
</tr>
<tr>
<td>
<code>loadBalancerAttributes</code><br/>
<em>
map[string]string
</em>
</td>
<td>
<p>LoadBalancerAttributes is a set of key-value pairs for ALB attributes.</p>
</td>
</tr>
<tr>
<td>
<code>listenPorts</code><br/>
<em>
<a href="#planetscale.com/v2.ALBPort">
[]ALBPort
</a>
</em>
</td>
...
<em>
<a href="#planetscale.com/v2.ALBTargetType">
ALBTargetType
</a>
</em>
</td>
<td>
<p>TargetType specifies how to route traffic to backends.
Default: &ldquo;instance&rdquo;</p>
</td>
</tr>
<tr>
<td>
...
<h3 id="planetscale.com/v2.ALBPort">ALBPort
</h3>
<p>
(<em>Appears on:</em>
...
<h3 id="planetscale.com/v2.ALBProtocol">ALBProtocol
...
<h3 id="planetscale.com/v2.ALBScheme">ALBScheme
(<code>string</code> alias)</h3>
<p>
(<em>Appears on:</em>
<a href="#planetscale.com/v2.ALBIngressSpec">ALBIngressSpec</a>)
...
<h3 id="planetscale.com/v2.ALBTargetType">ALBTargetType
(<code>string</code> alias)</h3>
<p>
(<em>Appears on:</em>
<a href="#planetscale.com/v2.ALBIngressSpec">ALBIngressSpec</a>)
...
<h3 id="planetscale.com/v2.AdminProxyAuth">AdminProxyAuth
(<code>string</code> alias)</h3>
<p>
(<em>Appears on:</em>
...
<h3 id="planetscale.com/v2.AdminProxySpec">AdminProxySpec
</h3>
<p>
(<em>Appears on:</em>
<a href="#planetscale.com/v2.PlanetScaleClusterSpec">PlanetScaleClusterSpec</a>)
</p>
<p>
<p>AdminProxySpec configures a proxy for exposing Vitess status pages to admins.</p>
</p>
<table class="table table-striped">
<thead class="thead-dark">
<tr>
...
<td>
<p>Image is the container image for the admin proxy.
...
<td>
<p>Replicas is the number of proxy instances to deploy.
Default: Let the operator choose.</p>
</td>
</tr>
<tr>
...
<td>
<p>Resources determines the compute resources reserved for each proxy replica.</p>
</td>
</tr>
<tr>
<td>
<code>auth</code><br/>
<em>
<a href="#planetscale.com/v2.AdminProxyAuth">
AdminProxyAuth
</a>
</em>
</td>
<td>
<p>Auth specifies how to authenticate and authorize requests.
WARNING: Setting this to &ldquo;None&rdquo; is insecure and should only be done when
...
<td>
<p>AuthSecret is a reference to the config Secret for proxy authentication
and authorization. This must point to an auth config file if the &ldquo;auth&rdquo;
field is not &ldquo;None&rdquo;.</p>
</td>
</tr>
<tr>
<td>
...
your admin proxy pods. WARNING: These affinity rules will override all default affinities
...
<td>
<p>Service can optionally be used to customize the admin-proxy Service.</p>
</td>
</tr>
</tbody>
</table>
<h3 id="planetscale.com/v2.AdminProxyStatus">AdminProxyStatus
</h3>
<p>
(<em>Appears on:</em>
<a href="#planetscale.com/v2.PlanetScaleClusterStatus">PlanetScaleClusterStatus</a>)
</p>
<p>
...
<td>
<p>Available indicates whether the admin proxy is deployed and healthy.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>ServiceName is the name of the Service for this cluster&rsquo;s proxy.</p>
</td>
</tr>
</tbody>
</table>
...
<td>
<p>AuthSecret is a reference to the Secret to use for the Azure authentication.</p>
</td>
</tr>
</tbody>
</table>
...
<td>
<p>Policy specifies rules for automatic creation and deletion of backups.
Default: Don&rsquo;t create or delete backups automatically.</p>
</td>
</tr>
</tbody>
</table>
...
<h3 id="planetscale.com/v2.FederationSpec">FederationSpec
</h3>
<p>
(<em>Appears on:</em>
<a href="#planetscale.com/v2.PlanetScaleClusterSpec">PlanetScaleClusterSpec</a>)
...
<tr>
<td>
<code>globalServiceDiscovery</code><br/>
<em>
...
<td>
<p>GlobalServiceDiscovery tells the operator how to connect services to each
other across Kubernetes clusters.</p>
<p>Note that the operator itself doesn&rsquo;t implement global service discovery.
For certain features to work across Kubernetes clusters, such as
deploying etcd, the operator requires that a solution for global service
discovery is already present. These settings let you tell the operator
what it needs to do to tap into the particular service discovery solution
you have.</p>
...
<tr>
<td>
<code>globalLockserverInstances</code><br/>
<em>
...
<td>
<p>GlobalLockserverInstances configures the distribution of instances of the
global lockserver cluster. This is required unless the PlanetScaleCluster
is configured to connect to an external global lockserver.</p>
<p>If specified, there must be exactly 3 entries. The global lockservice
will be available as long as at least 2 of the 3 instances are healthy.
This allows the global lockservice to tolerate one whole region in this
set becoming unavailable. The availability of regions that do not have
global lockserver instances will not impact the availability of the
global lockservice, even if those regions do contain other parts of the
Vitess cluster (e.g. tablets).</p>
<p>WARNING: Migration of an already-deployed instance to a different region
is currently NOT supported. These instances must not be moved after
initial deployment of a given PlanetScaleCluster.</p>
<p>Default: Assume an external global lockserver is configured.</p>
</td>
</tr>
<tr>
<td>
<code>regionalLockserver</code><br/>
<em>
<a href="#planetscale.com/v2.LockserverSpec">
LockserverSpec
</a>
...
<td>
<p>RegionalLockserver specifies either a deployed or external lockserver
...
<h3 id="planetscale.com/v2.GCEIngressSpec">GCEIngressSpec
</h3>
<p>
(<em>Appears on:</em>
<a href="#planetscale.com/v2.IngressClassSpec">IngressClassSpec</a>)
...
<tr>
<td>
<code>allowHTTP</code><br/>
<em>
bool
</em>
</td>
<td>
<p>AllowHTTP specified whether HTTP is allowed.
Default: false</p>
</td>
</tr>
</tbody>
...
<h3 id="planetscale.com/v2.GlobalLockserverInstance">GlobalLockserverInstance
</h3>
<p>
(<em>Appears on:</em>
...
<p>
<p>GlobalLockserverInstance configures one of a set of federated lockserver
instances.</p>
</p>
<table class="table table-striped">
<thead class="thead-dark">
...
<tr>
<td>
<code>ProviderRegion</code><br/>
<em>
<a href="#planetscale.com/v2.ProviderRegion">
ProviderRegion
</a>
</em>
</td>
...
<p>ProviderRegion identifies the region in a given provider to which the
operator should deploy this lockserver instance.
Required.</p>
</td>
</tr>
<tr>
...
<h3 id="planetscale.com/v2.GlobalServiceDiscoverySpec">GlobalServiceDiscoverySpec
</h3>
<p>
(<em>Appears on:</em>
<a href="#planetscale.com/v2.FederationSpec">FederationSpec</a>)
...
<p>
<p>GlobalServiceDiscoverySpec configures how the operator creates global services.</p>
</p>
<table class="table table-striped">
<thead class="thead-dark">
<tr>
...
<td>
<p>ServiceAnnotations specifies annotations that should be added to a
Kubernetes Service object that is expected to route globally to Pods in
any Kubernetes cluster.</p>
</td>
</tr>
</tbody>
</table>
<h3 id="planetscale.com/v2.GrafanaMonitoringSpec">GrafanaMonitoringSpec
</h3>
<p>
(<em>Appears on:</em>
...
<td>
<p>Image is the container image for Grafana.
Default: Let the operator choose.</p>
</td>
</tr>
<tr>
...
<td>
<p>Replicas is the number of Grafana instances to deploy.
Default: Let the operator choose.</p>
</td>
</tr>
<tr>
...
<td>
<p>Resources determines the compute resources reserved for each Grafana replica.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Affinity allows you to set rules that constrain the scheduling of
your Grafana pods. WARNING: These affinity rules will override all default affinities
that we set; in turn, we can&rsquo;t guarantee optimal scheduling of your pods if you
choose to set this field.</p>
</td>
</tr>
...
<h3 id="planetscale.com/v2.GrafanaMonitoringStatus">GrafanaMonitoringStatus
</h3>
<p>
(<em>Appears on:</em>
...
<td>
<p>Available indicates whether the Grafana dashboard is deployed and healthy.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>ServiceName is the name of the Service for this cluster&rsquo;s Grafana.</p>
</td>
</tr>
</tbody>
</table>
<h3 id="planetscale.com/v2.IngressClassSpec">IngressClassSpec
</h3>
<p>
(<em>Appears on:</em>
...
<code>alb</code><br/>
<em>
<a href="#planetscale.com/v2.ALBIngressSpec">
ALBIngressSpec
</a>
</em>
</td>
...
<code>gce</code><br/>
<em>
<a href="#planetscale.com/v2.GCEIngressSpec">
GCEIngressSpec
</a>
</em>
</td>
...
<h3 id="planetscale.com/v2.IngressRuleTemplate">IngressRuleTemplate
</h3>
<p>
(<em>Appears on:</em>
<a href="#planetscale.com/v2.IngressTemplateSpec">IngressTemplateSpec</a>)
...
<td>
<p>ServiceSelector specifies which Services to expose through this rule.
The controller will keep the list of backends in the rule updated
as this set of Services changes.</p>
</td>
</tr>
<tr>
<td>
...
<h3 id="planetscale.com/v2.IngressTemplate">IngressTemplate
</h3>
<p>
<p>IngressTemplate is a template for automatically generating Ingress objects.</p>
</p>
<table class="table table-striped">
<thead class="thead-dark">
<tr>
...
<td>
<p>IngressClass configures settings that are specific to a particular
Ingress implementation. Only one subfield should be set at a time.
Default: Generate a purely implementation-agnostic Ingress.</p>
</td>
</tr>
</table>
</td>
...
<h3 id="planetscale.com/v2.IngressTemplateSpec">IngressTemplateSpec
</h3>
<p>
(<em>Appears on:</em>
...
<h3 id="planetscale.com/v2.IngressTemplateStatus">IngressTemplateStatus
</h3>
<p>
(<em>Appears on:</em>
<a href="#planetscale.com/v2.IngressTemplate">IngressTemplate</a>)
...
<td>
<p>Paths is the total number of paths generated from the path template.</p>
</td>
</tr>
</tbody>
</table>
...
<h3 id="planetscale.com/v2.MonitoringSpec">MonitoringSpec
</h3>
<p>
(<em>Appears on:</em>
<a href="#planetscale.com/v2.PlanetScaleClusterSpec">PlanetScaleClusterSpec</a>)
...
<p>
<p>MonitoringSpec specifies the type of monitoring infrastructure to deploy.</p>
</p>
<table class="table table-striped">
<thead class="thead-dark">
<tr>
...
<h3 id="planetscale.com/v2.MonitoringStatus">MonitoringStatus
</h3>
<p>
(<em>Appears on:</em>
<a href="#planetscale.com/v2.PlanetScaleClusterStatus">PlanetScaleClusterStatus</a>)
...
<p>
<p>MonitoringStatus is a summary of the status of the monitoring infrastructure.</p>
</p>
<table class="table table-striped">
<thead class="thead-dark">
<tr>
...
<h3 id="planetscale.com/v2.NetworkPoliciesSpec">NetworkPoliciesSpec
</h3>
<p>
(<em>Appears on:</em>
<a href="#planetscale.com/v2.PlanetScaleClusterSpec">PlanetScaleClusterSpec</a>)
...
<h3 id="planetscale.com/v2.PlanetScaleClusterSpec">PlanetScaleClusterSpec
</h3>
<p>
(<em>Appears on:</em>
<a href="#planetscale.com/v2.PlanetScaleCluster">PlanetScaleCluster</a>)
...
<h3 id="planetscale.com/v2.PlanetScaleClusterStatus">PlanetScaleClusterStatus
</h3>
<p>
(<em>Appears on:</em>
<a href="#planetscale.com/v2.PlanetScaleCluster">PlanetScaleCluster</a>)
...
<td>
<p>RegionalLockserver is the status of the regional lockserver, if any.</p>
</td>
</tr>
<tr>
<td>
...
<code>monitoring</code><br/>
<em>
<a href="#planetscale.com/v2.MonitoringStatus">
MonitoringStatus
</a>
</em>
</td>
...
<code>adminProxy</code><br/>
<em>
<a href="#planetscale.com/v2.AdminProxyStatus">
AdminProxyStatus
</a>
</em>
</td>
...
<h3 id="planetscale.com/v2.PrometheusMonitoringSpec">PrometheusMonitoringSpec
</h3>
<p>
(<em>Appears on:</em>
<a href="#planetscale.com/v2.MonitoringSpec">MonitoringSpec</a>)
...
<p>
<p>PrometheusMonitoringSpec configures a Prometheus deployment for the cluster.</p>
</p>
<table class="table table-striped">
<thead class="thead-dark">
<tr>
...
<td>
<p>Version of Prometheus to be deployed.
Default: Let the operator choose.</p>
</td>
</tr>
<tr>
...
<td>
<p>Image can optionally be used to override the image URL for Prometheus.
...
Default: Use the prometheus-operator default.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Replicas is the number of Prometheus instances to deploy.
Default: Let the operator choose.</p>
</td>
</tr>
<tr>
...
<td>
<p>Time duration Prometheus shall retain data for. Default is &lsquo;24h&rsquo;,
...
<td>
<p>PersistentVolumeClaimSpec for Prometheus to store metrics
Default: Use an emptyDir volume.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Resources determines the compute resources reserved for each Prometheus replica.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Affinity allows you to set rules that constrain the scheduling of
your Prometheus pods. WARNING: These affinity rules will override all default affinities
that we set; in turn, we can&rsquo;t guarantee optimal scheduling of your pods if you
choose to set this field.</p>
</td>
</tr>
...
<td>
<p>ExternalLabels are Prometheus labels (not Kubernetes labels) to add to any time series or alerts when communicating with
...
<td>
<p>Service can optionally be used to customize the Prometheus Service.</p>
</td>
</tr>
</tbody>
</table>
<h3 id="planetscale.com/v2.PrometheusMonitoringStatus">PrometheusMonitoringStatus
</h3>
<p>
(<em>Appears on:</em>
<a href="#planetscale.com/v2.MonitoringStatus">MonitoringStatus</a>)
...
<td>
<p>ServiceName is the name of the Service for this cluster&rsquo;s Prometheus.</p>
</td>
</tr>
</tbody>
</table>
<h3 id="planetscale.com/v2.ProviderRegion">ProviderRegion
</h3>
<p>
(<em>Appears on:</em>
<a href="#planetscale.com/v2.GlobalLockserverInstance">GlobalLockserverInstance</a>, 
...
<td>
<p>Provider is the name of the cloud provider in which the region lives.
This can be any arbitrary value as long as it matches the provider value
supplied to the operator instance that should deploy into this region.
Example: &ldquo;aws&rdquo;.
Required.</p>
</td>
</tr>
<tr>
...
<td>
<p>Region is the name of a region within the specified provider.
This can be any arbitrary value as long as it matches the region value
supplied to the operator instance that should deploy into this region.
Example: &ldquo;us-west-1&rdquo;.
Required.</p>
</td>
</tr>
</tbody>
...
<a href="#planetscale.com/v2.VitessLockserverTLSParams">VitessLockserverTLSParams</a>, 
<a href="#planetscale.com/v2.VitessShardTemplate">VitessShardTemplate</a>)
</p>
<p>
...
with either the &lsquo;volumeName&rsquo; or &lsquo;initContainer&rsquo; fields instead.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>InitContainer specifies an init container to run to fetch secret data
from any arbitrary source. This can be used as an alternative to storing
secret data in Kubernetes Secret objects.</p>
<p>You should design the command and/or image to place secret data into the
&lsquo;/output&rsquo; directory of the init container&rsquo;s filesystem. Make sure the
command still works if the destination file already exists
(e.g. allow overwriting) since the init container might run more than
once on a given Pod. Also make sure to leave the output files with
permissions that allow Vitess processes to read them.</p>
<p>The &lsquo;key&rsquo; field defines the name of the file within the output directory
to load for this particular piece of secret data.</p>
<p>You can use one container image to provide more than one piece of secret
data by having the command place multiple files in the output directory.
You can then specify that same init container for multiple secret sources
but with a different &lsquo;key&rsquo; value (file name).</p>
</td>
</tr>
<tr>
<td>
...
<p>When &lsquo;initContainer&rsquo; is used, this specifies the name of the file to load
within the output directory filled by the init container.</p>
</td>
</tr>
</tbody>
</table>
...
<a href="#planetscale.com/v2.GrafanaMonitoringSpec">GrafanaMonitoringSpec</a>, 
<a href="#planetscale.com/v2.PlanetScaleClusterSpec">PlanetScaleClusterSpec</a>, 
<a href="#planetscale.com/v2.PrometheusMonitoringSpec">PrometheusMonitoringSpec</a>, 
...
<h3 id="planetscale.com/v2.VitessBackupPolicy">VitessBackupPolicy
</h3>
<p>
(<em>Appears on:</em>
<a href="#planetscale.com/v2.ClusterBackupSpec">ClusterBackupSpec</a>)
...
<td>
<p>BackupIntervalHours is the time (in hours) to wait between taking new
backups automatically for a given shard in a given storage location.
You should make sure to set this interval well below the expiry interval
for MySQL binary logs, so your most recent backup is always at a
replication position that is still present in the master&rsquo;s binary logs.
Default: 24 hours</p>
</td>
</tr>
<tr>
<td>
<code>minRetentionHours</code><br/>
<em>
int32
</em>
</td>
<td>
<p>MinRetentionHours is the minimum time (in hours) to retain each backup.
...
<tr>
<td>
<code>minRetentionCount</code><br/>
<em>
int32
</em>
</td>
<td>
<p>MinRetentionCount is the minimum number of backups to retain for a given
shard in a given storage location. Even if a backup is past the
...
might be left without any backup from which to restore.
Default: 1</p>
</td>
</tr>
</tbody>
...
<td>
<p>Region is the name of the region that this Vitess Cell should run in. This is optional if all cells are in the same
region, but if any cells set a region then every cell must set a region.
Example: us-west-1.
Optional.</p>
</td>
</tr>
...
<td>
<p>Provider is the name of the cloud provider this Vitess Cell should run in. It&rsquo;s fine to use whatever value you like
here, as long as it matches the provider value you supply to the operator instance in charge of this cell. Effectively
a provider is just a namespace within which region names live. This is optional if all cells are in the same provider,
but if any cells set a provider then every cell must set a provider.
Example: aws.
Optional.</p>
</td>
</tr>
...
Default: Put this cell&rsquo;s topology data in the global lockserver
(if federation is off) or in a shared, per-region lockserver
(if federation is on) instead of in its own per-cell lockserver.</p>
</td>
</tr>
<tr>
<td>
...
<h3 id="planetscale.com/v2.VitessImageMysqlFlavor">VitessImageMysqlFlavor
(<code>string</code> alias)</h3>
<p>
(<em>Appears on:</em>
...
<h3 id="planetscale.com/v2.VitessImageParams">VitessImageParams
</h3>
<p>
(<em>Appears on:</em>
<a href="#planetscale.com/v2.PlanetScaleClusterSpec">PlanetScaleClusterSpec</a>)
...
<p>
<p>VitessImageParams are values used to build the Vitess container image URL.</p>
</p>
<table class="table table-striped">
<thead class="thead-dark">
<tr>
...
<td>
<p>Registry is the base registry address.
Default: us.gcr.io</p>
</td>
</tr>
<tr>
...
<td>
<p>Repository is the path within the registry to the desired image repository.
Default: planetscale-vitess/lite</p>
</td>
</tr>
<tr>
<td>
<code>mysqlFlavor</code><br/>
<em>
...
<td>
<p>MysqlFlavor is the component of the generated image tag that determines
which MySQL flavor/variant is installed in the image alongside Vitess.
Default: Use the upstream Vitess project&rsquo;s default MySQL flavor.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Version is the component of the generated image tag that determines
the version of Vitess installed in the image.</p>
</td>
</tr>
</tbody>
</table>
...
<td>
<p>MigrateTraffic indicates what kind of traffic we should migrate from another partitioning to this partitioning.
Only one target partitioning should have MigrateTraffic set at a time. If multiple partitionings have &ldquo;All&rdquo; set
for MigrateTraffic, the operator will not proceed to switch traffic, and a user will be alerted via the status
section of the VitessKeyspace.
Default: None</p>
</td>
</tr>
</tbody>
</table>
<h3 id="planetscale.com/v2.VitessKeyspacePartitioningSpecAnnotations">VitessKeyspacePartitioningSpecAnnotations
</h3>
<p>
(<em>Appears on:</em>
<a href="#planetscale.com/v2.VitessKeyspaceSpecAnnotations">VitessKeyspaceSpecAnnotations</a>)
</p>
<p>
<p>VitessKeyspacePartitioningSpecAnnotations defines spec-like fields that we pass down to
VitessKeyspace objects through annotations with the specannotations package.</p>
</p>
<table class="table table-striped">
<thead class="thead-dark">
<tr>
...
<td>
<p>MigrateTraffic should match the MigrateTraffic flag of the Partitioning.</p>
</td>
</tr>
</tbody>
</table>
...
<h3 id="planetscale.com/v2.VitessKeyspaceSpecAnnotations">VitessKeyspaceSpecAnnotations
</h3>
<p>
<p>VitessKeyspaceSpecAnnotations defines spec-like fields that we pass down to
VitessKeyspace objects through annotations with the specannotations package.</p>
</p>
<table class="table table-striped">
<thead class="thead-dark">
...
<tr>
<td>
<code>Federated</code><br/>
<em>
bool
</em>
</td>
<td>
<p>Federated indicates whether we are currently federated and matches the output of the federated() helper method on the PlanetscaleClusterSpec.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Partitionings represents an ordered list of options related to each partitioning, in the same order as the partionings list in the VitessKeyspace template.</p>
</td>
</tr>
</tbody>
</table>
...
<h3 id="planetscale.com/v2.VitessKeyspaceTraffic">VitessKeyspaceTraffic
(<code>string</code> alias)</h3>
<p>
(<em>Appears on:</em>
<a href="#planetscale.com/v2.VitessKeyspacePartitioning">VitessKeyspacePartitioning</a>, 
<a href="#planetscale.com/v2.VitessKeyspacePartitioningSpecAnnotations">VitessKeyspacePartitioningSpecAnnotations</a>)
</p>
<p>
<p>VitessKeyspaceTraffic represents a valid combination of read and write traffic.</p>
</p>
...
<h3 id="planetscale.com/v2.VitessLockserverTLSParams">VitessLockserverTLSParams
</h3>
<p>
(<em>Appears on:</em>
<a href="#planetscale.com/v2.PlanetScaleClusterSpec">PlanetScaleClusterSpec</a>)
...
<p>
<p>VitessLockserverTLSParams contains optional data used to connect to a lockserver that
is TLS enabled.</p>
</p>
<table class="table table-striped">
<thead class="thead-dark">
...
<td>
<p>ClientCertSecret is a secret source for the client cert to use to connect to a TLS enabled lockserver.</p>
</td>
</tr>
<tr>
<td>
<code>clientKeySecret</code><br/>
<em>
<a href="#planetscale.com/v2.SecretSource">
SecretSource
</a>
...
<td>
<p>ClientKeySecret is a secret source for the client key to use to connect to a TLS enabled lockserver.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>ServerCACertSecret is a secret source for the CA cert to use to validate the server cert when
connecting to a TLS enabled lockserver.</p>
</td>
</tr>
</tbody>
</table>
...
<tr>
<td>
<code>recoverDeadMaster</code><br/>
<em>
bool
</em>
</td>
<td>
<p>RecoverDeadMaster specifies whether you want the operator to automatically handle a failure scenario where the master
has completely failed. Complete master failure is detected when the master cannot be reached directly, and none of the replicas
in the shard are currently replicating, or able to communicate with the master in any way. It essentially is a quorum where all
tablets in a shard agree that the master is dead. In the case of DeadMasterProtection being enabled, we will automatically elect
a new master from a healthy replica in the given shard to handle the failure case for you.</p>
<p>WARNING: It is highly recommended that you only run dead master recovery with enforceSemiSync turned on, to prevent the potential loss of committed transactions.
If enforceSemiSync is not enabled, a dead master recovery may appear to be no different from the perspective of a client than the experience of true data loss,
even in circumstances where data can be manually recovered from the old dead master.</p>
<p>Default: false.</p>
</td>
</tr>
<tr>
<td>
<code>deadMasterThresholdSeconds</code><br/>
<em>
int32
</em>
</td>
<td>
<p>DeadMasterThresholdSeconds is the number of seconds for which a master must be consistently detected as dead before a recovery (if enabled) will be attempted.
This threshold is important to prevent spurious detection.
Decreasing it will improve response time at the risk of causing flapping.
Default: 10.</p>
</td>
</tr>
<tr>
<td>
<code>ignoreDeadMasterCell</code><br/>
<em>
bool
</em>
</td>
<td>
<p>IgnoreDeadMasterCell specifies whether you want to ignore the master cell entirely when getting a quorum from tablets around whether master is dead.</p>
<p>WARNING: It is highly recommended that you do not set this to true unless you have manually configured semi-sync to operate with cross-cell guarantees.</p>
<p>Default: false</p>
</td>
</tr>
<tr>
...
<h3 id="planetscale.com/v2.VitessShardSpecAnnotations">VitessShardSpecAnnotations
</h3>
<p>
<p>VitessShardSpecAnnotations is where the definition of all spec annotations we intend to put on the VitessShard object lives.
Turning these into a map[string]string for placement into annotation, and translation back out of annotations should
happen via the specannotations package.</p>
</p>
<table class="table table-striped">
<thead class="thead-dark">
<tr>
...
<td>
<p>RecoverDeadMaster indicates whether we recover from dead master. This matches the RecoverDeadMaster field in the ReplicationSpec.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>DeadMasterThresholdSeconds indicates the maximum acceptable time that a dead master state may persist for before we attempt recovery.
This matches the field in the ReplicationSpec.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>IgnoreDeadMasterCell indicates that we should ignore the master&rsquo;s cell when getting a quorum to determine if master is dead.
This matches the IgnoreDeadMasterCell field in the ReplicationSpec.</p>
</td>
</tr>
</tbody>
</table>
...
<tr>
<td>
<code>preferredMasterRegions</code><br/>
<em>
<a href="#planetscale.com/v2.ProviderRegion">
[]ProviderRegion
</a>
...
<td>
<p>PreferredMasterRegions are the regions in which the operator will prefer to elect a master when possible.
The first item in the list will be most preferred, the second will be the next most preferred, and so on.
Be sure to define a replica pool in at least one cell within each region listed here.</p>
<p>Default: Use the order of the tablet pools list as the preference order.</p>
</td>
</tr>
</tbody>
</table>
